...
maps_actual subroutine
	...
	byte METATILE_ROCKS,                      METATILE_SAND,  METATILE_SAND,  METATILE_SAND,  METATILE_SHALLOW_WATER, METATILE_SAND,  METATILE_SAND,  METATILE_SAND,  METATILE_SAND,  METATILE_WATER
	byte METATILE_LEFT_TUNNEL_ENTRANCE_LIGHT, METATILE_SAND,  METATILE_SAND,  METATILE_SAND,  METATILE_SHALLOW_WATER, METATILE_SAND,  METATILE_SAND,  METATILE_SAND,  METATILE_SAND,  METATILE_WATER
	byte METATILE_ROCKS,                      METATILE_SAND,  METATILE_SAND,  METATILE_WATER, METATILE_WATER,         METATILE_WATER, METATILE_WATER, METATILE_WATER, METATILE_WATER, METATILE_WATER
	byte METATILE_ROCKS,                      METATILE_ROCKS, METATILE_ROCKS, METATILE_ROCKS, METATILE_ROCKS,         METATILE_ROCKS, METATILE_ROCKS, METATILE_ROCKS, METATILE_ROCKS, METATILE_ROCKS
	mapExtraData C64_COLOR_DARK_GREY, C64_COLOR_LIGHT_BLUE, C64_COLOR_LIME, C64_COLOR_BROWN, MAP_NULL, MAP_NULL, MAP_NULL, MAP_NULL, tanuki_tunnel_0_map_feature_script, tanuki_tunnel_name
