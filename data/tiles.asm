...
tiles subroutine
	...
	tileExtraData C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, TILE_MOVEMENT_WALL
	; Dirt path top left concave
	byte WORLD_CHAR_DIRT_PATH_TOP_LEFT_CONCAVE, WORLD_CHAR_DIRT_PATH_TOP, WORLD_CHAR_DIRT_PATH_LEFT, WORLD_CHAR_DIRT_PATH
	tileExtraData C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_RED, TILE_MOVEMENT_CLEAR
	; Dirt path top right concave
	byte WORLD_CHAR_DIRT_PATH_TOP, WORLD_CHAR_DIRT_PATH_TOP_RIGHT_CONCAVE, WORLD_CHAR_DIRT_PATH, WORLD_CHAR_DIRT_PATH_RIGHT
	tileExtraData C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_RED, C64_MULTICOLOR_GREEN, TILE_MOVEMENT_CLEAR
	; Dirt path bottom left concave
	byte WORLD_CHAR_DIRT_PATH_LEFT, WORLD_CHAR_DIRT_PATH, WORLD_CHAR_DIRT_PATH_BOTTOM_LEFT_CONCAVE, WORLD_CHAR_DIRT_PATH_BOTTOM
	tileExtraData C64_MULTICOLOR_GREEN, C64_MULTICOLOR_RED, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, TILE_MOVEMENT_CLEAR
	; Dirt path bottom right concave
	byte WORLD_CHAR_DIRT_PATH, WORLD_CHAR_DIRT_PATH_RIGHT, WORLD_CHAR_DIRT_PATH_BOTTOM, WORLD_CHAR_DIRT_PATH_BOTTOM_RIGHT_CONCAVE
	tileExtraData C64_MULTICOLOR_RED, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, TILE_MOVEMENT_CLEAR
	; Vertical brick wall
	byte WORLD_CHAR_BRICK_WALL_VERTICAL_0, WORLD_CHAR_BRICK_WALL_VERTICAL_0, WORLD_CHAR_BRICK_WALL_VERTICAL_1, WORLD_CHAR_BRICK_WALL_VERTICAL_1
	tileExtraData C64_MULTICOLOR_RED, C64_MULTICOLOR_RED, C64_MULTICOLOR_RED, C64_MULTICOLOR_RED, TILE_MOVEMENT_WALL
	; Vertical brick wall with key hole
	byte WORLD_CHAR_BRICK_WALL_VERTICAL_0, WORLD_CHAR_BRICK_WALL_VERTICAL_0, WORLD_CHAR_BRICK_WALL_VERTICAL_1, WORLD_CHAR_BRICK_WALL_VERTICAL_WITH_KEY_HOLE
	tileExtraData C64_MULTICOLOR_RED, C64_MULTICOLOR_RED, C64_MULTICOLOR_RED, C64_MULTICOLOR_RED, TILE_MOVEMENT_WALL
	; Vertical brick wall with water grate
	byte WORLD_CHAR_BRICK_WALL_VERTICAL_0, WORLD_CHAR_WALL_VERTICAL_WATER_GRATE, WORLD_CHAR_BRICK_WALL_VERTICAL_1, WORLD_CHAR_WALL_VERTICAL_WATER_GRATE
	tileExtraData C64_MULTICOLOR_RED, C64_MULTICOLOR_BLUE, C64_MULTICOLOR_RED, C64_MULTICOLOR_BLUE, TILE_MOVEMENT_WALL
	; Tree stump
	byte WORLD_CHAR_GRASS_0, WORLD_CHAR_GRASS_1, WORLD_CHAR_TREE_TRUNK_LEFT, WORLD_CHAR_TREE_TRUNK_RIGHT
	tileExtraData C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, TILE_MOVEMENT_WALL
	; Fallen tree
	byte WORLD_CHAR_FALLEN_TREE_TOP_LEFT, WORLD_CHAR_FALLEN_TREE_TOP_RIGHT, WORLD_CHAR_FALLEN_TREE_BOTTOM_LEFT, WORLD_CHAR_FALLEN_TREE_BOTTOM_RIGHT
	tileExtraData C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, C64_MULTICOLOR_GREEN, TILE_MOVEMENT_WALL