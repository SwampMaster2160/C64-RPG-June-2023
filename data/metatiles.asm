...
metatiles subroutine
	...
	byte TILE_RIGHT_TUNNEL_ENTRANCE_TOP, TILE_ROCKS,                    TILE_RIGHT_TUNNEL_ENTRANCE_BOTTOM,     TILE_ROCKS                             ; Right tunnel entrance
	byte TILE_ROCKS,                     TILE_LEFT_TUNNEL_ENTRANCE_TOP, TILE_ROCKS,                            TILE_LEFT_TUNNEL_ENTRANCE_BOTTOM       ; Left tunnel entrance