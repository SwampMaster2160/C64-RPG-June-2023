...
two_islands_path_1_map_feature_script subroutine
	byte MAP_FEATURE_ENTITY, ENTITY_BLOCK_HORIZONTAL, 2, 0
	byte MAP_FEATURE_ENTITY, ENTITY_BLOCK_HORIZONTAL, 19, 0
	byte MAP_FEATURE_END

two_islands_path_2_map_feature_script subroutine
	byte MAP_FEATURE_ENTITY, ENTITY_BLOCK_HORIZONTAL, 0, 0
	byte MAP_FEATURE_ENTITY, ENTITY_BLOCK_HORIZONTAL, 17, 0
	byte MAP_FEATURE_END

two_islands_path_0_map_feature_script subroutine
	byte MAP_FEATURE_ENTITY, ENTITY_BLOCK_VERTICAL, 0, 5
	byte MAP_FEATURE_END
