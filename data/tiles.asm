...
tiles subroutine
	...
	tileExtraData C64_COLOR_BLACK, C64_COLOR_BLACK, C64_COLOR_BLACK, C64_COLOR_BLACK, TILE_MOVEMENT_CLEAR
	; House roof left
	...
	tileExtraData C64_MULTICOLOR_CYAN, C64_MULTICOLOR_CYAN, C64_MULTICOLOR_BLACK, C64_MULTICOLOR_YELLOW, TILE_MOVEMENT_WALL
